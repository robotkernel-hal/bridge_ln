...
static std::string service_datatype_to_ln(const std::string& datatype) {
    if (datatype == "string")
                ...
                if (std::string::npos != equals_idx)
                {
                    ...
                    if (is_primitive) {
                        ...
                        if (real_key == "string") {
                            ...
                            ss_sub_md << ln_dt << " data" << std::endl;//<< real_key << endl;
        ...
        std::map<std::string, std::string>& mds_map) 
{
    ...
    if (message_definition["request"]) {
        ...
        ln_bridge::process_node(request, ss_md, ss_signature, mds_map);
    }
    ...
    if (message_definition["response"]) {
        ...
        ln_bridge::process_node(response, ss_md, ss_signature, mds_map);
    }
